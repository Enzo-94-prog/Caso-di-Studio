...
/**
 *Costante utilizzata per memorizzare il numero massimo di utenti da mostrare nella classifica.
 */
...
/**
 *Costante utilizzata per memorizzare il numero massimo di stelle che l’utente puo' attribuire come voto
 *ad una risorsa (a partire da 0).
 */
#define N_MASSIMO_STELLE_VALUTAZIONE 5
/**
 *Costante utilizzata per memorizzare il numero massimo di risorse che l’utente puo' visualizzare
 *nella stampa delle risorse piu' scaricate.
 */
...
typedef struct {
	...
	int numero_download_totali; /**< Numero di download effettuati/Numero di volte che le proprie risorse sono state scaricate dall'utilizzatore/dal creatore.*/
...
/**
 * Struttura dati contenente i dettagli di ogni attivita' avvenuta sulla piattaforma.
 */
typedef struct {
