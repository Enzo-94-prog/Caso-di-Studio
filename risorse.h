 ...
 * @brief Cancella dal file risorse la risorsa scelta dal proprio creatore.
...
/**
 * @brief Ricerca all'interno del file risorse la struttura, se esiste, corrispondente alla risorsa dal titolo specificato dall'utilizzatore.
 * @param file_utenti Puntatore al file utenti.
 * @param file_risorse Puntatore al file risorse.
 * @param file_attivita Puntatore al file attivita'.
 */
...
/**
 * @brief Ricerca all'interno del file risorse la struttura, se esiste, corrispondente alla risorsa associata alla parola chiave immessa dall'utilizzatore.
 * @param file_utenti Puntatore al file utenti.
 * @param file_risorse Puntatore al file risorse.
 * @param file_attivita Puntatore al file attivita'.
 */
...
/**
 * @brief Stampa a schermo una serie di risorse affini a quelle gia' scaricate (almeno una) in precedenza dall'utilizzatore.
 * @param file_utenti Puntatore al file utenti.
 * @param file_risorse Puntatore al file risorse.
 * @param file_attivita Puntatore al file attivita'.
 */
...
/**
 * @brief Visualizza tutte le risorse create dal creatore.
 * @param file_risorse Puntatore al file risorse.
 */
...
/**
 * @brief Visualizza le prime 5 risorse piu' scaricate della piattaforma.
 * @param file_risorse Puntatore al file risorse.
 */
